About oset-feedstock
====================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/oset-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3163&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/oset-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `oset` can be installed with `conda`:
...
It is possible to list all of the versions of `oset` available on your platform with `conda`:
...
```
mamba search oset --channel conda-forge
```
...
mamba repoquery search oset --channel conda-forge

# List packages depending on `oset`:
mamba repoquery whoneeds oset --channel conda-forge

# List dependencies of `oset`:
mamba repoquery depends oset --channel conda-forge
```
